  ...
  <v-card elevation id="v-card-detail">
    ...
    <v-card-text>
      ...
      <v-row>
        ...
        <v-col cols="12" sm="10">
          <v-list-item-subtitle>{{ selectedResult.properties.county }}</v-list-item-subtitle>
          <v-list-item-title>{{ selectedResult.properties.region }}</v-list-item-title>
          <v-list-item-title>{{ selectedResult.properties.country }}</v-list-item-title>
        </v-col>
      </v-row>
      <v-divider></v-divider>
      <v-row>
