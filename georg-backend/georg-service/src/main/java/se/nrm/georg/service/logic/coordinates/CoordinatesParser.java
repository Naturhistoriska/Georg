...
public class CoordinatesParser {
  ...
  public String addCoordinatesTransformation(String jsonString) throws JSONException {
  ...
  public String addCoordinatesTransformationNewPlace
        (String jsonString, Double lat, Double lng)  throws JSONException {
  ...
  public String addCoordinatesTransformation 
        (String jsonString, Double lat, Double lng) throws JSONException {
    JSONObject json = parser.stringToJson(jsonString);
    JSONArray array = parser.getFeatures(json);
